...
def insert_user(name, age, email, password_hash, diet_pref, occupation=None, city=None, allergies=None, notes=None, gender=None):
    ...
    try:
        ...
        query = """
        INSERT INTO user_profiles (name, age, email, password, diet_pref, occupation, city, allergies, notes, submitted_at, gender)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
        """
        values = (name, age, email, password_hash, diet_pref, occupation, city, allergies, notes, datetime.now(), gender)
